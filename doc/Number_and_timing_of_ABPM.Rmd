...
Figure S1: Estimated mean systolic blood pressure over time since falling asleep (left column) and time since midnight (right column) for participants in the CARDIA (top row) and JHS cohorts (bottom row).
`r fp_par(line_spacing = 1)`
...
Figure S2: Estimated mean diastolic blood pressure over time since falling asleep (left column) and time since midnight (right column) for participants in the CARDIA (top row) and JHS cohorts (bottom row).
`r fp_par(line_spacing = 1)`
